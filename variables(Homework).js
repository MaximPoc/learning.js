...
// let x = 11;
// x = NaN;
// console.log(x === x) // returns false при значении x= NaN, поскольку NaN не 

// http://www.codewars.com/kata/50ee6b0bdeab583673000025 - в задаче был прописан оператор сравнения (==), а не присвоения(=)

// http://www.codewars.com/kata/560f8d41cf6e1fe5c900002e - решение ниже. Долго думал из-за того что в условии сказано вернуть значение при котором x === x выдавал бы false(с помощью return), а я пытался распечатать результат
